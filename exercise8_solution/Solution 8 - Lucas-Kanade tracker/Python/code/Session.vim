...
nnoremap <silent> ,b :FzfBuffers
nnoremap <silent> ,o :FzfFiles
nnoremap ,a :Ack! 
...
nnoremap <silent> <F7> :%s/\s\+$//e''
nmap <F8> :TagbarToggle
map <C-O> :NERDTreeToggle
nnoremap <F6> :call PreviewWindowOpened()
nnoremap <F5> :YcmForceCompileAndDiagnostics
nnoremap <F4> :YcmCompleter GoTo
map <F9> :YcmCompleter FixIt
...
silent only
silent tabonly
cd ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code
...
exe 'vert 2resize ' . ((&columns * 120 + 105) / 211)
argglobal
balt main.py
setlocal keymap=
setlocal noarabic
...
let s:l = 176 - ((58 * winheight(0) + 29) / 59)
...
wincmd w
argglobal
if bufexists("main.m") | buffer main.m | else | edit main.m | endif
balt main.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 128 - ((57 * winheight(0) + 29) / 59)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 128
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 113 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 112 + 105) / 211)
argglobal
balt trackKLTRobustly.m
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
wincmd w
argglobal
if bufexists("trackKLTRobustly.m") | buffer trackKLTRobustly.m | else | edit trackKLTRobustly.m | endif
balt track_klt_robustly.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
setlocal backupcopy=
...
set winwidth=1
exe 'vert 1resize ' . ((&columns * 113 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 97 + 105) / 211)
argglobal
balt trackKLT.m
setlocal keymap=
setlocal noarabic
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 63 - ((30 * winheight(0) + 27) / 55)
if s:l < 1 | let s:l = 1 | endif
keepjumps exe s:l
normal! zt
keepjumps 63
...
wincmd w
argglobal
if bufexists("trackKLT.m") | buffer trackKLT.m | else | edit trackKLT.m | endif
balt track_klt.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
...
keepjumps 25
normal! 0
lcd ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code
wincmd w
exe 'vert 1resize ' . ((&columns * 113 + 105) / 211)
exe 'vert 2resize ' . ((&columns * 97 + 105) / 211)
tabnext 3
set stal=1
badd +1 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/main.py
badd +1 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/main.m
badd +102 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/track_klt.py
badd +25 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/trackKLT.m
badd +79 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/get_warped_patch.py
badd +0 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/plotMatches.m
badd +25 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/track_brute_force.py
badd +33 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/warp_image.py
badd +0 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/trackKLTRobustly.m
badd +0 ~/PhD/Courses/VisionAlgorithms/rpg_cvcourse_exercises/UZH_FS22/Python/08_klt/code/track_klt_robustly.py
